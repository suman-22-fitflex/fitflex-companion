    ...
    <section id="workouts">
      ...
      <div className="card-grid">
        <div className="card" onClick={() => showSection('fullbodyEx')}>
          ...
          <h3>Full Body</h3>
          <p>
            All major muscles in one session.<br />
            <strong>Time:</strong> 45–60 min
          </p>
        </div>
        <div className="card" onClick={() => showSection('cardioEx')}>
          ...
          <h3>Cardio Blast</h3>
          <p>
            Boost heart rate & burn calories.<br />
        ...
        <div className="card" onClick={() => showSection('strengthEx')}>
          ...
          <p>
            Increase strength & muscle mass.<br />
            <strong>Time:</strong> 45–60 min
          </p>
        </div>
      </div>
